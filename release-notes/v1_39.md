...
The Java language server adopts the [Deprecated Diagnostics Tag](/updates/v1_37#_diagnosticstagdeprecated) which renders the code that references deprecated types or members with a strike-through line.

![Java deprecated tag support](images/1_38/java-deprecated-method.png)
